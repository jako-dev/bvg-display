...
// ===== Firmware / OTA =====
// version.h is generated by the release CI job from the release tag and is
// not committed to the repo (see .github/workflows/build-firmware.yml). Its
// absence — every local/dev build — falls back to the default below.
